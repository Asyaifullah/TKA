...
<head>
    ...
    <style>
        ...
        /* ============================================================
           FIX FOOTER — tambahkan ini ke shared.css juga
           Masalah: page-wrapper pakai flex column tapi konten
           tidak mendorong footer ke bawah karena .page-content
           tidak flex:1. Solusi: pastikan layout mengisi viewport.
        ============================================================ */
        ...
        .page-content {
            flex: 1;            /* ← ini yang bikin footer stay bottom */
        }
        .site-footer {
            margin-left: 0;     /* footer sudah di dalam .page-wrapper */
            flex-shrink: 0;
        }
        ...
        .tpl-card.active .tpl-radio {
            background: var(--c-primary);
            border-color: var(--c-primary);
        }
        .tpl-card.active .tpl-radio::after {
            content: '';
...
<div class="page-wrapper">
    ...
    <header class="topnav">
        <div class="topnav-breadcrumb">
            <a href="<?= base_url('admin/dashboard') ?>" style="color:var(--c-text-muted); text-decoration:none;"><i class="fas fa-home"></i></a>
            <i class="fas fa-chevron-right" style="font-size:8px;"></i>
            <strong>Kirim Notifikasi</strong>
        </div>
        <div class="topnav-actions">
            <a href="<?= base_url('admin/dashboard') ?>" class="topnav-btn" title="Kembali">
    ...
    <main class="page-content">
        ...
        <div class="page-header">
            ...
            <div class="page-subtitle">Kirim notifikasi manual kepada perusahaan terdaftar</div>
        </div>
        ...
        <?php if($this->session->flashdata('success')): ?>
            <div class="flash-alert flash-success" id="flashMsg">
                ...
                <button class="flash-close" onclick="document.getElementById('flashMsg').remove()"><i class="fas fa-xmark"></i></button>
            </div>
        <?php endif; ?>
                    ...
                    <div class="surface">
                        ...
                        <div class="surface-body">
                            ...
                            <div class="field-wrap">
                                <label class="field-label required">Penerima</label>
                            ...
                            <div class="field-wrap">
                                ...
                                <div class="field-hint">
                                    ...
                                    Biarkan kosong jika tidak ada halaman tujuan spesifik.
                                </div>
                            </div>
                ...
                <div>
                    ...
                    <div class="surface">
                        <div class="surface-header">
                            ...
                            <span style="font-size:0.68rem; color:var(--c-text-muted);">Klik untuk mengisi form</span>
                        </div>
                            ...
                            <div class="tpl-grid">
                                <button type="button" class="tpl-card" onclick="fillTemplate(1, this)">
                                    ...
                                    <div class="tpl-body">
                                        ...
                                        <div class="tpl-desc">Surat keterangan TKA selesai dan siap diunduh.</div>
                                    </div>
                                ...
                                <button type="button" class="tpl-card" onclick="fillTemplate(2, this)">
                                    ...
                                    <div class="tpl-body">
                                        ...
                                        <div class="tpl-desc">Pengajuan TKA telah diverifikasi dan disetujui.</div>
                                    </div>
                                    <div class="tpl-radio"></div>
                                </button>
                                ...
                                <button type="button" class="tpl-card" onclick="fillTemplate(3, this)">
                                    ...
                                    <div class="tpl-body">
                                        ...
                                        <div class="tpl-desc">Data TKA belum lengkap, perlu dilengkapi segera.</div>
                                    </div>
                                    <div class="tpl-radio"></div>
                                </button>

                                <button type="button" class="tpl-card" onclick="fillTemplate(4, this)">
                                    <div class="tpl-icon ti-slate"><i class="fas fa-bullhorn"></i></div>
                                    <div class="tpl-body">
                                        <div class="tpl-title">Pengumuman</div>
                                        <div class="tpl-desc">Kirim informasi atau pengumuman umum.</div>
                                    </div>
                                    <div class="tpl-radio"></div>
                                </button>
                            </div>
                    ...
                    <div class="tips-box">
                        ...
                        <div class="tip-item">
                            ...
                            <span>Sertakan nama TKA di pesan agar penerima tahu pengajuan mana yang dimaksud.</span>
                        </div>
                        <div class="tip-item">
                            <div class="tip-bullet">3</div>
                            <span>Tambahkan link tujuan agar penerima langsung diarahkan ke halaman yang relevan.</span>
                        </div>
                        <div class="tip-item">
                            <div class="tip-bullet">4</div>
                            <span>Periksa kembali preview sebelum mengirim notifikasi.</span>
                        </div>
                    </div>
    ...
    <!-- Footer (di dalam .page-wrapper agar flex column bekerja) -->
