...
<head>
    ...
    <title>Detail TKA — SITLAKEB TKA Admin</title>
    ...
    <style>
        ...
        /* ── Info grid (sama persis detail perusahaan) ── */
        .info-grid {
...
<div class="page-wrapper">
    ...
    <header class="topnav">
        <div class="topnav-breadcrumb">
            <a style="color:var(--c-text-muted);text-decoration:none;"><i class="fas fa-home"></i></a>
            ...
            <div class="surface">
                ...
                <div class="log-list">
                    <?php foreach($logs as $log):
                        $isApprove = ($log->status === 'approve');
                    ?>
                    <div class="log-item">
                        <div class="log-dot-wrap">
                            <div class="log-dot <?= $isApprove ? 'ld-approve' : 'ld-reject' ?>">
                        ...
                        <div class="log-body">
                            <div class="log-role">
                                <?= ucfirst($log->role) ?>
                                <span class="log-badge <?= $isApprove ? 'lb-approve' : 'lb-reject' ?>">
                                    <i class="fas <?= $isApprove ? 'fa-check-circle' : 'fa-times-circle' ?>" style="font-size:9px;"></i>
                                    <?= $isApprove ? 'Disetujui' : 'Ditolak' ?>
                                </span>
                            </div>
                            <div class="log-time">
            ...
            <div class="surface" style="margin-bottom:16px;">
                ...
                <div class="surface-body" style="padding:16px;display:flex;flex-direction:column;gap:8px;">
                    ...
                    <?php if($isSelesai && isset($tka->surat_teks_approved) && $tka->surat_teks_approved == 1): ?>
                        <a href="<?= base_url('admin/download_surat_word/'.$tka->id) ?>" class="btn-primary" style="justify-content:center;">
                            <i class="fas fa-download"></i> Download Surat
                        </a>
                    <?php endif; ?>

                    <a href="<?= base_url('admin/edit_nomor_surat/'.$tka->id) ?>" class="btn-secondary" style="justify-content:center;">
                        <i class="fas fa-hashtag"></i> Edit Nomor Surat
                    </a>

                    <a href="<?= base_url('admin/edit_tka/'.$tka->id) ?>" class="btn-secondary" style="justify-content:center;">
                        <i class="fas fa-pen"></i> Edit Data TKA
                    </a>

                    <div style="margin-top:4px;padding-top:12px;border-top:1px solid var(--c-border);">
                        <a href="<?= base_url('admin/delete_tka/'.$tka->id) ?>"
